...
class TooltipManager:
    ...
    ACTION_EDIT_PREFERENCES = "Open preferences dialog to configure application settings"
    ...
    FILTER_COLUMN_FIELD = (
        "Enter text to filter a specific column. " "Select the column from the dropdown first."
    )
